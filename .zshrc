...
rm $hyprland_conf/* -rf; cp $dotfiles/hypr/ $dotfiles/foot/ $dotfiles/.zshrc $dotfiles/.bashrc $HOME/.hyprland-conf/LICENSE $HOME/.hyprland-conf/README.md $hyprland_conf -R; cd $hyprland_conf; git add.; git commit -m $1 -m $2; git push
...
local config=$HOME/.config/
cp $hyprland_conf/hypr $hyprland_conf/foot $hyrpland_conf/waybar $config -R; cp $hyrpland_conf/.zshrc $hyrpland_conf/.bashrc $HOME/ -i
}
